...
import { IChatGroupAdapter } from '../../../component/chat/core/chat-group-adapter';
import { IChatParticipant } from '../../../component/chat/core/chat-participant';
import { ChatParticipantStatus } from '../../../component/chat/core/chat-participant-status.enum';
import { ChatParticipantType } from '../../../component/chat/core/chat-participant-type.enum';
import { Group } from '../../../component/chat/core/group';
import { Message } from '../../../component/chat/core/message';
import { MessageType } from '../../../component/chat/core/message-type.enum';
import { ParticipantResponse } from '../../../component/chat/core/participant-response';
...
export class DemoAdapter extends ChatAdapter implements IChatGroupAdapter
{
    ...
    },
    {
        participantType: ChatParticipantType.User,
        id: 8,
        displayName: "Lorde Petyr 'Littlefinger' Baelish Lorde Petyr 'Littlefinger' Baelish",
    ...
    listFriends(): Observable<ParticipantResponse[]> {
        return of(DemoAdapter.mockedParticipants.map(user => {
            ...
            participantResponse.metadata = {
                totalUnreadMessages: Math.floor(Math.random() * 2)
            }
