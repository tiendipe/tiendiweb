    ...
    children: [
      {
        ...
        loadChildren: () =>
          import('./component/side-filter/side-filter.module').then(
            (m) => m.SideFilterModule
          ),
      },
      {
        path: 'sidebag',
        ...
        loadChildren: () =>
          import('./component/bag/bag.module').then((m) => m.BagModule),
      },
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            './component/payment-and-delivery/payment-and-delivery.module'
          ).then((m) => m.PaymentAndDeliveryModule),
      },
...

      {
        ...
        loadChildren: () =>
          import('./component/recent-order-more/recent-order-more.module').then(
            (m) => m.RecentOrderMoreModule
          ),
      },
      {
        ...
        loadChildren: () =>
          import('./component/order-summary/order-summary.module').then(
